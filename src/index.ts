...
app.post('/:network(idiazabalnet|hangzhounet|granadanet)', middlewareLogger((req: any, res: any) => popKeys(req, res)))
app.get('/:network(idiazabalnet|hangzhounet|granadanet)', middlewareLogger((req: any, res: any) => count(req, res)))
app.post('/:network(idiazabalnet|hangzhounet|granadanet)/ephemeral', middlewareLogger((req: any, res: any) => provisionEphemeralKey(req, res)))
app.get('/:network(idiazabalnet|hangzhounet|granadanet)/ephemeral/:id/keys/:key', middlewareLogger((req: any, res: any) => pk(req, res)))
app.post('/:network(idiazabalnet|hangzhounet|granadanet)/ephemeral/:id/keys/:key', middlewareLogger((req: any, res: any) => sign(req, res))) 
