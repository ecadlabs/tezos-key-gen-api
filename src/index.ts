...
app.post('/:network(ithacanet|hangzhounet|granadanet)', middlewareLogger((req: any, res: any) => popKeys(req, res)))
app.get('/:network(ithacanet|hangzhounet|granadanet)', middlewareLogger((req: any, res: any) => count(req, res)))
app.post('/:network(ithacanet|hangzhounet|granadanet)/ephemeral', middlewareLogger((req: any, res: any) => provisionEphemeralKey(req, res)))
app.get('/:network(ithacanet|hangzhounet|granadanet)/ephemeral/:id/keys/:key', middlewareLogger((req: any, res: any) => pk(req, res)))
app.post('/:network(ithacanet|hangzhounet|granadanet)/ephemeral/:id/keys/:key', middlewareLogger((req: any, res: any) => sign(req, res))) 
