...
app.get('/:network(babylonnet|carthagenet)/ephemeral/:id/keys/:key', (req: any, res: any) => pk(req, res))
app.post('/:network(babylonnet|carthagenet)/ephemeral/:id/keys/:key', (req: any, res: any) => sign(req, res))
