...
app.post('/:network(edonet|galphanet|galpha2net|florencenet)', middlewareLogger((req: any, res: any) => popKeys(req, res)))
app.get('/:network(edonet|galphanet|galpha2net|florencenet)', middlewareLogger((req: any, res: any) => count(req, res)))
app.post('/:network(edonet|galphanet|galpha2net|florencenet)/ephemeral', middlewareLogger((req: any, res: any) => provisionEphemeralKey(req, res)))
app.get('/:network(edonet|galphanet|galpha2net|florencenet)/ephemeral/:id/keys/:key', middlewareLogger((req: any, res: any) => pk(req, res)))
app.post('/:network(edonet|galphanet|galpha2net|florencenet)/ephemeral/:id/keys/:key', middlewareLogger((req: any, res: any) => sign(req, res))) 
